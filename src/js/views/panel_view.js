    ...
    var PanelView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            ...
            this.listenTo(this.model,
                'change:zoom change:dx change:dy change:width change:height change:channels change:theZ change:theT change:z_start change:z_end change:z_projection change:min_export_dpi change:vertical_flip change:horizontal_flip',
                this.render_image);
            this.listenTo(this.model,
